...
| 日志类型 | 路径 | 文件格式 |
|----------|------|----------|
| 固件日志 | `E:\logs\serial\` | `serial_log_*.txt` |
| 小程序日志 | `E:\logs\mini\` | `mini_log_*.txt` |
| 云函数日志 | `E:\logs\cloudfunction\` | `cloudfunction_deploy_*.txt` |
| Git 日志 | `E:\logs\git\` | `git_push_*.txt` |
...
| 日志目录 | 来源 | 文件格式 |
|----------|------|----------|
| `E:\logs\serial\` | 固件串口监控 | `serial_log_*.txt` |
| `E:\logs\mini\` | 小程序日志服务器 | `mini_log_*.txt` |
| `E:\logs\cloudfunction\` | 云函数部署 | `cloudfunction_deploy_*.txt` |
| `E:\logs\git\` | Git 推送 | `git_push_*.txt` |
